...
import os
ncores="128"   
os.environ["OMP_NUM_THREADS"] = ncores # export OMP_NUM_THREADS=4
os.environ["OPENBLAS_NUM_THREADS"] = ncores # export OPENBLAS_NUM_THREADS=4 
os.environ["MKL_NUM_THREADS"] = ncores # export MKL_NUM_THREADS=6
os.environ["VECLIB_MAXIMUM_THREADS"] = ncores # export VECLIB_MAXIMUM_THREADS=4
os.environ["NUMEXPR_NUM_THREADS"] = ncores # export NUMEXPR_NUM_THREADS=6
